...
Dissipate = ("Dissipate Token","96348698-ae05-4c59-89bb-e79dad50ad1f")
...
Freeze = ("Freeze: -1 on non-spell attacks, lumbering, 2 damage to living creatures, remove 1 at end of activation", "c40445e9-118c-4212-af4c-76d12d4c1fe0")
...
Hate = ("Hate","8c8dbf31-6ba3-4d14-ab1f-3771960671a5")
...
Love = ("Love","50861f40-93b8-4dc6-a6ba-108cc584de8e")
...
Suffocate = ("Suffocate: Life -2 - Removal Cost: 2", "c89baa9e-21c8-4f8c-8635-b258d5d80172")
...
Valor = ("Valor", "f7fc4b07-9596-48f4-a049-d5be58ae254c")
...
listControlMarkers = [ControlMarkerRed,ControlMarkerBlue,ControlMarkerGreen,ControlMarkerPurple]

##########################		Board Settings			############################
gameBoardsDict = {
				1 : {"boardName":"Westlock - 4X3","zoneDef":(4,3,250),"buttonColor":"#171e78"},
				2 : {"boardName":"Inferno - 4x3","zoneDef":(4,3,250),"buttonColor":"#de2827"},
				3 : {"boardName":"Forest - 4x3","zoneDef":(4,3,250),"buttonColor":"#01603e"},
				4 : {"boardName":"Double Westlock - 6x4","zoneDef":(6,4,167),"buttonColor":"#171e78"},
...
##########################		Lists			############################
listMageWeapons = ["Johktari Hunting Knife","Faith Healer\'s Staff", "Rod of the Arcanum","Hellstar","Resplendent Bow", "Shifratar", "Ivarium Halberd", "Elemental Staff", "Bo Staff", "Soulreaper", "Dragon\'s Lance", "Gladius"]
typeChannelingList = ["Mana Flower","Mana Crystal","Moonglow Amulet","Wispwillow Amulet"]
typeIgnoreList = ["Internal","Phase","DiceRoll","V'Tar Orb Off","V'Tar Orb On"]#,'Vine Marker Green','Vine Marker Black']
tokenList = ["Armor","Banish","Bleed","Burn","Charge","Cripple","Corrode","Disable","Daze","Grapple","Growth","Ki","Mana","Melee","Rage",
